...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.7\textwidth}
		\centering
		\resizebox{0.57\width}{!}{\input{plots/OpenMP/Runtime_coarse.pgf}}
		\caption{\label{fig::Rcoarse} coarse mesh}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.7\textwidth}
		\centering
		\resizebox{0.57\width}{!}{\input{plots/OpenMP/Runtime_medium.pgf}}
		\caption{\label{fig::Rmedium} medium mesh}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.7\textwidth}
		\centering
		\resizebox{0.57\width}{!}{\input{plots/OpenMP/Runtime_fine.pgf}}
